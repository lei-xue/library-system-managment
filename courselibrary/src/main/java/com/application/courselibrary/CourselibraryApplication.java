...
import com.application.courselibrary.entity.*;
...
public class CourselibraryApplication {
	...
	public CommandLineRunner initialCreate(BookService bookService){
		return (args) -> {
			Book book1 = new Book("ABC2", "Book name1", "My first book");
			...
			Book book2 = new Book("ABC1", "Book name2", "My second book");
			...
			Book book3 = new Book("ABC21", "Book name3", "My third book");
